      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 hola2">
            <h1>Distribución</h1>
            <!-- <h3>Distribución</h3> -->
            <p>Estamos a las órdenes. Si requieres nuestros servicios desde otra parte de la República Mexcicana, pone en contacto con nosotros.</p>
            <button type="button" class="btn btn-danger">Contáctanos</button>
          </div>
        </div>
      </div>
    </div>
